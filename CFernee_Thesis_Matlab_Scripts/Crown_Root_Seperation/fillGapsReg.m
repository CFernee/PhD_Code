...
enamVertInd=unique(idx);

for i=1:length(enamVertInd)
    enamVert(enamVertInd,1)=1;
    
%     vertSet=wholeTooth.faces(enamVertInd(i),:);
...
%find all enamVer vertices that are repeated throughout the mesh and set
%them all to 1.
