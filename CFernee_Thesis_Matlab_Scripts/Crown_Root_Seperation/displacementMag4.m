function [baselineMorphed]=displacementMag4(centroid,baseline,target,Num_Near_Neig,Steps)
%  centroid=centroid_2;
%  vertices_1=fv1_T.vertices;
%  vertices_2=fv2_T.vertices;
%  faces_2=fv2_T.faces;    
%  Num_Near_Neig=30;
[vertices_1]=baseline.vertices;
[vertices_2]=target.vertices;
[faces_1]=baseline.faces;
[faces_2]=target.faces;
...
Dmin=Dmin/j;
[baselineMorphed]=morphedMesh(Dmin,vertices_1,faces_1);
[baselineMorphed]=lp_smooth(baselineMorphed,1);
[vertices_1]=baselineMorphed.vertices;
